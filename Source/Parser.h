...
public:
	const std::string parse(const std::string& inputData, std::string& query, const std::vector<std::shared_ptr<BaseZGMLOperator>>& operators, const std::shared_ptr<BaseZGMLOperator>& defaulthOperator);
};